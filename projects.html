...
<!--Navigation Bar-->
  <div class="hero">
    ...
    <!--Introduction-->
        ...
        <div class="content">    
            <h1 class="wafa">Hello, I’m <span><strong>Amber</strong>!</span></h1>
            <p>I’m a PhD student researcher</p>
            <a href="#footer" class="btn">Let's Connect!</a>
        </div>
        </div>
...
<div class="container">
  ...
  <h2 class="section-title">Lorem Ipsum</h2>
    ...
    <div class="projects">
      <div class="container">
        <div class="left1" title="image of ai"></div>
        <div class="right1">
          <div class="contents">
            <h1>Artificial Intelligence</h1>
            <p> Privacy Leader Reflections on AI Innovation and AI Governance
            </p>
            <a href="https://google.com" class="card_btn">Learn More</a>
          </div>
        </div>
      </div>
    </div>
